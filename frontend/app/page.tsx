...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* HERO */}
      <section
        className="relative w-full overflow-hidden pt-40 pb-24 px-6 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage:
            "url('https://intelcorp.scene7.com/is/image/intelcorp/foundry-logo-stacked-illuminated-transparent-16x9:1920-1080?wid=1920&hei=1080&fmt=webp-alpha')",
        }}
      >
